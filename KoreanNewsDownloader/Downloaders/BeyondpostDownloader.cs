...
{
    internal class BeyondpostDownloader : DownloaderBase
    {
        public BeyondpostDownloader(HttpClient httpClient, ProxyHttpClient proxyHttpClient) : base(httpClient, proxyHttpClient)
        {
            HostUrls = new List<string>
            {
                "www.beyondpost.co.kr", "beyondpost.co.kr"
            };
        }
